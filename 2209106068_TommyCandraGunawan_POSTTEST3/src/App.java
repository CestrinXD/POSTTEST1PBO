...
public class App {
    ...
    public static void tambahbarang() {
        ...
        if (pilih.equals("1")) {
            ...
            String deskripsi = scanner.nextLine();
            System.out.print("Masukkan Brand Barang NonRT     : ");
            String brand = scanner.nextLine();

            NonRT barangNonRTBaru = new NonRT(nama, harga, deskripsi, brand);
        ...
        if (pilih.equals("1")) {
            ...
            if (databarangnonrt.isEmpty()) {
                ...
                for (int i = 0; i < databarangnonrt.size(); i++) {
                    ...
                    System.out.println("Brand     : " + databarangnonrt.get(i).getBrand());
                    System.out.println("===========================");
                }
            }
        } else {
